 ...
 */
 ...
 System.config({
     transpiler: 'ts',
    typescriptOptions: { 'experimentalDecorators': true },
    packages: {
        app: { defaultExtension: 'ts' },
        rxjs: { defaultExtension: 'js' } },
    meta: { 'typescript': { 'exports': 'ts' } },
    paths: { 'npm:': 'https://unpkg.com/' },
    map: { '@angular/common': 'npm:@angular/common' + version + '/bundles/common.umd.js',
           ...
           'typescript': 'npm:typescript@3.7.4/lib/typescript.js' }
});
